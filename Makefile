...
rel:
	...
	tar -caf filestore-cleanup-linux64.tar.xz filestore-cleanup LICENSE README.md systemd config.yaml.sample
	...
	upx filestore-cleanup
	tar -caf filestore-cleanup-linuxARM.tar.xz filestore-cleanup LICENSE README.md systemd config.yaml.sample
	...
	upx filestore-cleanup
	tar -caf filestore-cleanup-darwin64.tar.gz filestore-cleanup LICENSE README.md config.yaml.sample
	...
	zip filestore-cleanup-win64.zip filestore-cleanup.exe LICENSE README.md config.yaml.sample
